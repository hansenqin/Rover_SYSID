...
%                    theta = atan((y - y_0) ./ (x - x_0));
                   ...
                   ax_global = -sin(fitted_theta) .* dr_global + cos(fitted_theta) .* d2r_global ...
                                - sin(fitted_theta) .* dr_global - cos(fitted_theta) .* fitted_r;
                   ay_global = cos(fitted_theta) .* dr_global + sin(fitted_theta) .* d2r_global ...
                                + cos(fitted_theta) .* dr_global - sin(fitted_theta) .* fitted_r;
